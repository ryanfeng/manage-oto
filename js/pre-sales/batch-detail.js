...
define(['Tool','component','text!/tpl/pre-sales/batch-detail.html'],function(Tool,component,detail){
    ...
    var init = {
        ...
        category : function(){
            var data = {
                list : [
                    {text:"sn编码列表",active:(urlParam.func=="getBatchSnList"||!urlParam.func)?"active":"",func:"getBatchSnList"},
                    {text:"作废sn编码列表",active:urlParam.func=="getBatchDiscardSnList"?"active":"",func:"getBatchDiscardSnList"}
                ]
            };
            //创建分类
            Tool.category(data,{
