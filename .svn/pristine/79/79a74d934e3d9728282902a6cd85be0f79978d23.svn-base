...
* 设备用户页面
* */
define(['Tool','component','text!/tpl/user/device-user.html'],function(Tool,component,deviceUser){
    ...
    var init = {
        ...
        infoTable : function(dataList){
            ...
            console.log(Params.remainLifeSort,"32",(Params.remainLifeSort=="0"&&"倒序")||(Params.remainLifeSort=="1"&&"正序")||"滤网寿命");
            // 创建表格信息
            new Vue({
                el: '.info-table',
                data : {
