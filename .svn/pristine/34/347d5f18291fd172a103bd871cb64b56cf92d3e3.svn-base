 ...
 * 售后设备列表页面
 * */
define(['Tool','component','text!/tpl/sell-after/device.html'],function(Tool,component,device){
    ...
    var init = {
        ...
        infoTable : function(dataList,channelList,channelActive){
            ...
            console.log((Params.remainLifeSort=="")&&"selected",(Params.remainLifeSort=="1")&&"selected",(Params.remainLifeSort=="0")&&"selected");
            // 创建表格信息
            new Vue({
                el: '.info-table',
                data : {
